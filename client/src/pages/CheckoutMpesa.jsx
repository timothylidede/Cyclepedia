...
const Checkout = () => {
      ...
      axios
        ...
        .then((res) => {
          if (res.data.error) {
            ...
            const details = res.data.productDetails;
            setCartItems(cart);
  ...
  const lipanampesa = async (e) => {
    ...
    try {
      ...
      axios.post(`http://localhost:5000/api/user/completeorder`, orderData, {
        headers: {
          Authorization: "Bearer " + localStorage.authToken,
        },
      });
      ...
      <OuterWrapper>
        <Wrapper>
          ...
          <Form onSubmit={lipanampesa}>
            ...
            ></Input>
            <Action>
              <Button onClick={(e) => lipanampesa(e)}>CONFIRM ORDER</Button>
            </Action>
          </Form>
        </Wrapper>
      </OuterWrapper>
